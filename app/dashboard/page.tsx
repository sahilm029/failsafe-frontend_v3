  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <button className="inline-flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary-hover text-primary-foreground rounded font-medium transition-colors">
          <PlusIcon className="w-4 h-4" />
          Create Test
        </button>
        <button className="inline-flex items-center gap-2 px-4 py-2 bg-card hover:bg-card/80 text-text-primary rounded font-medium border border-border transition-colors">
          <UploadIcon className="w-4 h-4" />
          Import Config
        </button>
        <button
          onClick={handleRerunLast}
          className="inline-flex items-center gap-2 px-4 py-2 bg-card hover:bg-card/80 text-text-primary rounded font-medium border border-border transition-colors"
        >
